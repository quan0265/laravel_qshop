...
<div class="card shadow mb-4">
    ...
    <form role="form" action="{{route('slider.update', $slider->id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>Name</label>
            <input class="form-control" name="name" value="{{ $slider->name }}" placeholder="Enter text">
            @if($errors->has('name'))
        ...
        <div class="form-group">
            ...
            <img width="150" id="fileImage" src="{{ asset('public/uploads/slider/'.$slider->image) }}" alt="your image" />
            @if($errors->has('image'))
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control">
                ...
                <option value="0" @if($slider->status!=1) selected @endif >inactive</option>
            </select>
