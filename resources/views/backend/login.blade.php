                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form role="form" class="user" action="{{route('post.admin.login')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input name="remember" value="true" type="checkbox" class="custom-control-input" id="customCheck">
